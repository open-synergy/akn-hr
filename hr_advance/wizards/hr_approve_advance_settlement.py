...
class HrApproveAdvanceSettlement(models.TransientModel):
    _name = "hr.approve_advance_settlement"
    _description = "Approved Advance Settlement"
    ...
    settlement_id = fields.Many2one(
        string="# Cash Advance Realization",
    ...
    line_ids = fields.One2many(
        string="Details",
        comodel_name="hr.approve_advance_settlement_line",
...
class HrApproveAdvanceSettlementLine(models.TransientModel):
    _name = "hr.approve_advance_settlement_line"
    _description = "Approved Advance Settlement"

    wizard_id = fields.Many2one(
        string="Wizard",
        comodel_name="hr.approve_advance_settlement",
        ondelete="cascade",
    )
